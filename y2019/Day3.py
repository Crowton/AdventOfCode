...
#     return points
#
# wire1points = wirePoints(wire1)
# wire2points = wirePoints(wire2)
#
# inter = [p for p in wire1points if p in wire2points]
...
inter = [p for p in wire1points if p in wire2points]
print(min(wire1points[p] + wire2points[p] for p in inter))
